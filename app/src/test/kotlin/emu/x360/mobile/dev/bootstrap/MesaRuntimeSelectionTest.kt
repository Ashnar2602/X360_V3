...
class MesaRuntimeSelectionTest {
    @Test
    fun `auto selects mesa25 for odin2 adreno740 baseline devices`() {
        ...
        assertThat(resolved.reason).isEqualTo("auto-adreno740-baseline")
    }
    ...
    @Test
    fun `auto selects mesa26 for odin3 adreno830 baseline devices`() {
        val resolved = DeviceMesaRuntimePolicy.resolve(
            overrideMode = MesaRuntimeBranch.AUTO,
            properties = DeviceProperties(
                board = "sun",
        ...
        assertThat(resolved.reason).isEqualTo("auto-adreno830-baseline")
    }
